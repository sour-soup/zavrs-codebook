...
\section{Strings}
\tex{String Matching with FFT}{strings/fft\_match.tex} %можно переписать
%пускай останется на будущее
...
\code{Minkowski Sum}{geometry/minkowski.cpp} %добавить пояснения
%здесь можно шаблон подсмотреть
